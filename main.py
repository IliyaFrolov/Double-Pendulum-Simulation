...
def make_plot_double(pendulum_data, file_name=None):
    '''
    Uses the final data generated by the "make_data" method to produce plots of the position, velocity, acceleration and energy of the double pendulum.
...
def make_plot_single(pendulum, pendulum_data, file_name=None):
    '''
    Uses the final data generated by the "make_simple_pendulum" method to produce plots of the position, velocity, acceleration and energy of the simple pendulum.
    ...
    w = np.sqrt(g/pendulum.L)
    A = pendulum.angular_position[0]
    t = np.linspace(0, pendulum.time[-1], 10000)
    ...
    position_ax.set(title='Angular displacements of the Simple Pendulum over time.', ylabel='Angular displacement (radians)', xlabel='Time (s)')
    ...
    velocity_ax.set(title='Angular velocity of the Simple Pendulum over time.', ylabel='Angular velocity (radians/s)', xlabel='Time (s)')
    ...
    acceleration_ax.set(title='Angular acceleration of the Simple Pendulum over time.', ylabel='Angular acceleration (radians/s^2)', xlabel='Time (s)')
