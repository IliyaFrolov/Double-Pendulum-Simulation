...
class System():
    ...
    def __init__(self, length_1, mass_1, length_2, mass_2, initial_angular_position_1, initial_angular_velocity_1, initial_angular_position_2, initial_angular_velocity_2, steps, time):
        ...
        self.dwdt_1 = Acceleration(length_1, mass_1, length_2, mass_2, 1)
        self.dwdt_2 = Acceleration(length_1, mass_1, length_2, mass_2, 2)
        self.K1 = KineticEnergy(length_1, mass_1, length_2, mass_2, 1)
        self.U1 = PotentialEnergy(length_1, mass_1, length_2, mass_2, 1)
        self.K2 = KineticEnergy(length_1, mass_1, length_2, mass_2, 2)
        self.U2 = PotentialEnergy(length_1, mass_1, length_2, mass_2, 2)
        ...
        self.p1.angular_acceleration[0] = self.dwdt_1(initial_angular_position_1, initial_angular_velocity_1, initial_angular_position_2, initial_angular_velocity_2)
        self.p2.angular_acceleration[0] = self.dwdt_2(initial_angular_position_1, initial_angular_velocity_1, initial_angular_position_2, initial_angular_velocity_2)
        self.kinetic_energy[0] = self.K1(initial_angular_position_1, initial_angular_velocity_1, initial_angular_position_2, initial_angular_velocity_2) + self.K2(initial_angular_position_1, initial_angular_velocity_1, initial_angular_position_2, initial_angular_velocity_2)
        self.potential_energy[0] = self.U1(initial_angular_position_1, initial_angular_position_2) + self.U2(initial_angular_position_1, initial_angular_position_2)
    ...
    def model(self, t, initial_conditions):
        ...
        dwdt_1 = self.dwdt_1(theta_1, omega_1, theta_2, omega_2)
        dwdt_2 = self.dwdt_2(theta_1, omega_1, theta_2, omega_2)
    ...
    def run_simulation(self, method):
        for i in range(1, self.n+1):
            ...
            self.p1.angular_acceleration[i] = self.dwdt_1(theta_1, omega_1, theta_2, omega_2)
            ...
            self.p2.angular_acceleration[i] = self.dwdt_2(theta_1, omega_1, theta_2, omega_2)
            
            self.kinetic_energy[i] =  self.K1(theta_1, omega_1, theta_2, omega_2) + self.K2(theta_1, omega_1, theta_2, omega_2)
            self.potential_energy[i] = self.U1(theta_1, theta_2) + self.U2(theta_1, theta_2)
